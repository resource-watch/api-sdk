...
module APISdk
  class Dataset
    ...
    # Accessors
    define_attribute_methods :id, :name, :connector_type, :provider, :connector_url, :application
    changeable_attr_accessor :id, :name, :connector_type, :provider, :connector_url, :application
